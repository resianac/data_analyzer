    ...
    <Card>
        ...
        <CardContent>
            ...
            <div v-else class="flex flex-col items-center justify-center py-12 text-center">
                <Activity class="h-12 w-12 text-muted-foreground/30 mb-3" />
                <p class="text-sm text-muted-foreground">No data available</p>
                <p class="text-xs text-muted-foreground/70 mt-1">Data will appear here when available</p>
            </div>
        </CardContent>
    </Card>
</template>
